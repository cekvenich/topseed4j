...
public class ConditionalNode extends Node {
		...
		for (IfConditionNode conditionNode : this.conditions) {
			try {
				if (conditionNode.isDefault()
						|| checkCondition(model, conditionNode.getValue(), template.getExpressionHandler())
	...
	private boolean checkCondition(JadeModel model, String condition, ExpressionHandler expressionHandler)
